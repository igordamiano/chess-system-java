...
public class ChessMatch {
	...
	public ChessPiece replacePromotedPiece(String type) {
		...
		if (promoted == null) {
			throw new IllegalStateException("Nao existe peca para promover !!!");
		}
	...
	private Piece makeMove(Position source, Position target) {
		...
		// Especial move pequeno kingside rook
		...
		// Especial move grande queenside rook
		if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("Nao existe a cor " + color + " para o rei no tabuleiro");
	}
	...
	private void initialSetup() {
		/*
		 * // Posições para check-mate placeNewPiece('h', 7, new Rook(board,
		 * Color.WHITE)); placeNewPiece('d', 1, new Rook(board, Color.WHITE));
